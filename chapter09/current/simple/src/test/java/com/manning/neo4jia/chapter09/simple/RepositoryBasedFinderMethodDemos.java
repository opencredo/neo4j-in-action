...
public class RepositoryBasedFinderMethodDemos {
    ...
    public void demoDynamicNameRelatedQueryMethodsOnRepository() {
        ...
        User simUser = userRepository.simulateFindByNameWhenUsingLabelBasedStrategy("Susan").iterator().next();
    ...
    public void demoDynamicFindByNameAndFriendsNameMethodOnRepository() {
        ...
        Iterable<User> explicitUserNamesResults = userRepository.simulateFindByNameLikeAndFriendsNameWhenUsingLabelBasedStrategy("John.*", "Susan");
    ...
    public void demoDynamicFindByReferredByName() {
        ...
        Iterable<User> simUsersReferredBySusan = userRepository.simulateFindByReferredByNameWhenUsingLabelBasedStrategy("Susan");
    ...
    public void demoDynamicFindByReferredByNameLikeMethod() {
        ...
        Iterable<User> simUsersReferredBySomeoneWithNameStartingWithS = userRepository.simulateFindByReferredByNameLikeWhenUsingLabelBasedStrategy("S.*");
