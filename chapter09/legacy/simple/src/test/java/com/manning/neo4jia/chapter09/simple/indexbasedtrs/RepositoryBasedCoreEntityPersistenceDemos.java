...
import com.manning.neo4jia.chapter09.simple.indexbasedtrs.repository.MovieRepository;
...
import com.manning.neo4jia.chapter09.simple.indexbasedtrs.util.SimulatedIssueException;
...
public class RepositoryBasedCoreEntityPersistenceDemos {
    ...
    public void demoSaveUserAndThenLookupByIndexedUserId() {
        ...
        User loadedUserViaIndex = userRepository.findByPropertyValue("userId", "john001");
